"""
将阶跃函数替换为Logistic函数，并对线性部分施加对数损失，得到逻辑回归模型
"""
...
predict = tb.ops.Logistic(output)

# 损失函数，使用的是output节点，predict节点不参与反传
loss = tb.ops.loss.LogLoss(tb.ops.Multiply(label, output))
